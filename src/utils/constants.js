...
export const LOGO_RED = `${BASE_URL}/Netflix_Logo_PMS.png`;
...
export const AVATAR_RED = `${BASE_URL}/avatar-red.jpeg`;
export const AVATAR_BLUE = `${BASE_URL}/avatar-blue.jpeg`;
export const NETFLIX_LOGO = `${BASE_URL}/Netflix_Logo_PMS.png`;
